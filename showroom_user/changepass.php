...
if($newpass===$confpass)
{
  $sql="SELECT supass FROM showroom_user WHERE supass='$currpass' and suid='$uid' and status=1";
 $result = $conn->query($sql);
  if ($result->num_rows > 0){
    $sqlupdate = "UPDATE showroom_user SET supass='$newpass' WHERE supass='$currpass' and suid='$uid' and status=1";
